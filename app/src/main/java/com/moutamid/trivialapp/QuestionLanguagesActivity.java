...
public class QuestionLanguagesActivity extends AppCompatActivity {
    Button submit;
    int Score = 0;
    ...
    // CorrectAnswers
    String A1 = "English", A2 = "French", A3 = "Italian", A4 = "Chinese", A5 = "Around 7,000";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_question_languages);
